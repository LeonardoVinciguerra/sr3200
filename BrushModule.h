...
// Created:     30/08/2017
// Description: BrushModule class declaration
//
//---------------------------------------------------------------------------
#ifndef __BRUSHMODULE_H
#define __BRUSHMODULE_H

#include "MotorModule.h"

class BrushModule : public MotorModule
{
public:
	BrushModule( wxCommInterface* ComInt, int address );
	~BrushModule();
