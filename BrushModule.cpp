//---------------------------------------------------------------------------
//
// Name:        BrushModule.cpp
// Author:      Daniele Belloni, Gabriel Ferri
// Created:     07/05/2008
// Description: BrushModule class implementation
//
//---------------------------------------------------------------------------
#include "BrushModule.h"
#include "BrushModuleDefs.h"
#include "SerialCom.h"


BrushModule::BrushModule( wxCommInterface* ComInt, int address )
...
//-----------------------------------------------------------------------------
int BrushModule::Read_Reg_Micro( unsigned char RegAdd, unsigned short* Value )
{
...
//-----------------------------------------------------------------------------
int BrushModule::Write_Reg_Micro( unsigned char RegAdd, unsigned short Value )
{
...
----------------------------------------------------------------------*/
unsigned short BrushModule::GetVersion()
{
	if( isDisabled )
		return MOTOR_OK;
...
----------------------------------------------------------------------*/
int BrushModule::SetMinCurrent( int val )
{
	return MOTOR_OK;
}
...
RETURN:     MOTOR_OK on OK, MOTOR_ERROR on error
----------------------------------------------------------------------*/
int BrushModule::SetMaxCurrent( int val )
{
	return MOTOR_OK;
}
...
RETURN:     MOTOR_OK on OK, MOTOR_ERROR on error
----------------------------------------------------------------------*/
int BrushModule::SetNominalCurrent( int val )
{
	return MOTOR_OK;
}
...
----------------------------------------------------------------------*/
int BrushModule::GetNominalCurrent()
{
	return MOTOR_OK;
}
...
RETURN:     MOTOR_OK on OK, MOTOR_ERROR on error
----------------------------------------------------------------------*/
int BrushModule::FreeRotation( int sensoRot )
{
	return MOTOR_OK;
}
...
RETURN:     MOTOR_OK on OK, MOTOR_ERROR on error
----------------------------------------------------------------------*/
int BrushModule::StopRotation( int ramp )
{
	return MOTOR_OK;
}
...
RETURN:     MOTOR_OK on OK, MOTOR_ERROR on error
----------------------------------------------------------------------*/
int BrushModule::MicroStepping( int Fraction )
{
	return MOTOR_OK;
}
...
----------------------------------------------------------------------*/
long BrushModule::ActualPosition()
{
	return MOTOR_OK;
}
...
RETURN:     MOTOR_OK on OK, MOTOR_ERROR on error
----------------------------------------------------------------------*/
int BrushModule::SetActualPosition( long pos )
{
	return MOTOR_OK;
}
...
RETURN:     MOTOR_OK on OK, MOTOR_ERROR on error
----------------------------------------------------------------------*/
int BrushModule::GotoPosRel( long pos )
{
	return MOTOR_OK;
}
...
RETURN:     MOTOR_OK on OK, MOTOR_ERROR on error
----------------------------------------------------------------------*/
int BrushModule::GotoPos0( long pos )
{
	return MOTOR_OK;
}
...
RETURN:     MOTOR_OK on OK, MOTOR_ERROR on error
----------------------------------------------------------------------*/
int BrushModule::MinimumFreq( int mFreq )
{
	return MOTOR_OK;
}
...
RETURN:     MOTOR_OK on OK, MOTOR_ERROR on error
----------------------------------------------------------------------*/
int BrushModule::MaximumFreq( long MFreq )
{
	return MOTOR_OK;
}
...
RETURN:     MOTOR_OK on OK, MOTOR_ERROR on error
----------------------------------------------------------------------*/
int BrushModule::Aceleration( long acc )
{
	return MOTOR_OK;
}
...
RETURN:     MOTOR_OK on OK, MOTOR_ERROR on error
----------------------------------------------------------------------*/
int BrushModule::Deceleration( long dec )
{
	return MOTOR_OK;
}
...
RETURN:     MOTOR_OK on OK, MOTOR_ERROR on error
----------------------------------------------------------------------*/
int BrushModule::SlopeValue( long slopeFactor )
{
	return MOTOR_OK;
}
...
----------------------------------------------------------------------*/
long BrushModule::ActualVelocity()
{
	return MOTOR_OK;
}
...
RETURN:     MOTOR_OK on OK, MOTOR_ERROR on error
----------------------------------------------------------------------*/
int BrushModule::SetOutputs( int outId, int outVal )
{
	if( isDisabled )
		return MOTOR_OK;
...
RETURN:     MOTOR_OK on OK, MOTOR_ERROR on error
----------------------------------------------------------------------*/
int BrushModule::SetLimitsCheck( int limit, int limitLevel )
{
	return MOTOR_OK;
}
...
RETURN:     MOTOR_OK on OK, MOTOR_ERROR on error
----------------------------------------------------------------------*/
int BrushModule::MotorEnable( int command )
{
	return MOTOR_OK;
}
...
----------------------------------------------------------------------*/
long BrushModule::GetEncoderActualPosition()
{
	return MOTOR_OK;
}
...
----------------------------------------------------------------------*/
int BrushModule::EncoderMode( int type, int mode )
{
	return MOTOR_OK;
}
...
----------------------------------------------------------------------*/
int BrushModule::GetEncoderMode( int type )
{
	return MOTOR_OK;
}
...
RETURN:     MOTOR_OK on OK, MOTOR_ERROR on error
----------------------------------------------------------------------*/
int BrushModule::InputsSetting( long val )
{
	return MOTOR_OK;
}
...
RETURN:     MOTOR_OK on success, MOTOR_ERROR otherwise
----------------------------------------------------------------------*/
int BrushModule::SearchPos0( int dir )
{
	return MOTOR_OK;
}
...
RETURN:     MOTOR_OK on OK, MOTOR_ERROR on error
----------------------------------------------------------------------*/
int BrushModule::SetDecay( int val )
{
	return MOTOR_OK;
}
...
RETURN:     MOTOR_OK on success, MOTOR_ERROR otherwise
----------------------------------------------------------------------*/
int BrushModule::SetPIDIqParams( long KP, long KI, long KD, long KC, long OMax, long OMin )
{
	return MOTOR_OK;
}
...
RETURN:     MOTOR_OK on success, MOTOR_ERROR otherwise
----------------------------------------------------------------------*/
int BrushModule::GetPIDIqParams( long *KP, long *KI, long *KD, long *KC, long *OMax, long *OMin )
{
	return MOTOR_OK;
}
...
RETURN:     MOTOR_OK on success, MOTOR_ERROR otherwise
----------------------------------------------------------------------*/
int BrushModule::SetPIDIdParams( long KP, long KI, long KD, long KC, long OMax, long OMin )
{
	return MOTOR_OK;
}
...
RETURN:     MOTOR_OK on success, MOTOR_ERROR otherwise
----------------------------------------------------------------------*/
int BrushModule::GetPIDIdParams( long *KP, long *KI, long *KD, long *KC, long *OMax, long *OMin )
{
	return MOTOR_OK;
}
...
RETURN:     MOTOR_OK on success, MOTOR_ERROR otherwise
----------------------------------------------------------------------*/
int BrushModule::SetPIDSpdParams( unsigned short set, long KP, long KI, long KD, long KC, long OMax, long OMin )
{
	return MOTOR_OK;
}
...
RETURN:     MOTOR_OK on success, MOTOR_ERROR otherwise
----------------------------------------------------------------------*/
int BrushModule::GetPIDSpdParams( unsigned short set, long *KP, long *KI, long *KD, long *KC, long *OMax, long *OMin )
{
	return MOTOR_OK;
}
...
RETURN:     MOTOR_OK on success, MOTOR_ERROR otherwise
----------------------------------------------------------------------*/
int BrushModule::SetPIDPosParams( unsigned short set, long KP, long KI, long KD, long KC, long OMax, long OMin )
{
	return MOTOR_OK;
}
...
RETURN:     MOTOR_OK on success, MOTOR_ERROR otherwise
----------------------------------------------------------------------*/
int BrushModule::GetPIDPosParams( unsigned short set, long *KP, long *KI, long *KD, long *KC, long *OMax, long *OMin )
{
	return MOTOR_OK;
}
...
----------------------------------------------------------------------*/
long BrushModule::GetLineEncoder()
{
	return MOTOR_OK;
}
...
RETURN:     MOTOR_OK on success, MOTOR_ERROR otherwise
----------------------------------------------------------------------*/
int BrushModule::SetLineEncoder( long lines )
{
	return MOTOR_OK;
}
...
----------------------------------------------------------------------*/
long BrushModule::GetPulsesPerRev()
{
	return MOTOR_OK;
}
...
RETURN:     MOTOR_OK on success, MOTOR_ERROR otherwise
----------------------------------------------------------------------*/
int BrushModule::SetPulsesPerRev( long ppr )
{
	return MOTOR_OK;
}
...
RETURN:     MOTOR_OK on success, MOTOR_ERROR otherwise
----------------------------------------------------------------------*/
int BrushModule::SetPoles( int poles )
{
	return MOTOR_OK;
}
...
----------------------------------------------------------------------*/
int BrushModule::GetCalibratedAngle()
{
	return MOTOR_OK;
}
...
RETURN:     MOTOR_OK on success, MOTOR_ERROR otherwise
----------------------------------------------------------------------*/
int BrushModule::SetCalibratedAngle( int angle )
{
	return MOTOR_OK;
}
...
----------------------------------------------------------------------*/
int BrushModule::GetLoggerTrigger()
{
	return MOTOR_OK;
}
...
RETURN:     MOTOR_OK on success, MOTOR_ERROR otherwise
----------------------------------------------------------------------*/
int BrushModule::SetLoggerTrigger( int trig )
{
	return MOTOR_OK;
}
...
----------------------------------------------------------------------*/
int BrushModule::GetLoggerPrescaler()
{
	return MOTOR_OK;
}
...
RETURN:     MOTOR_OK on success, MOTOR_ERROR otherwise
----------------------------------------------------------------------*/
int BrushModule::SetLoggerPrescaler( int prescal )
{
	return MOTOR_OK;
}
...
RETURN:     MOTOR_OK on success, MOTOR_ERROR otherwise
----------------------------------------------------------------------*/
int BrushModule::GetLoggerChannelData( int channel )
{
	return MOTOR_OK;
}
...
RETURN:     MOTOR_OK on success, MOTOR_ERROR otherwise
----------------------------------------------------------------------*/
int BrushModule::SetLoggerChannelInput( int channel, int input )
{
	return MOTOR_OK;
}
...
----------------------------------------------------------------------*/
long BrushModule::GetEncoderActualSpeed( int mode )
{
	return MOTOR_OK;
}
...
RETURN:     MOTOR_OK on success, MOTOR_ERROR otherwise
----------------------------------------------------------------------*/
int BrushModule::PWMEnable( int command )
{
	return MOTOR_OK;
}
...
RETURN:     MOTOR_OK on success, MOTOR_ERROR otherwise
----------------------------------------------------------------------*/
int BrushModule::PhaseEnable( int phase, int command )
{
	return MOTOR_OK;
}
...
RETURN:     MOTOR_OK on success, MOTOR_ERROR otherwise
----------------------------------------------------------------------*/
int BrushModule::ADCCalEnable( int command )
{
	return MOTOR_OK;
}
...
RETURN:     ADCx offset
----------------------------------------------------------------------*/
long BrushModule::GetADCOffset( int channel )
{
	return MOTOR_OK;
}
...
RETURN:     MOTOR_OK on success, MOTOR_ERROR otherwise
----------------------------------------------------------------------*/
int BrushModule::SetADCOffset( int channel, long val )
{
	return MOTOR_OK;
}
...
RETURN:     MOTOR_OK on success, MOTOR_ERROR otherwise
----------------------------------------------------------------------*/
int BrushModule::SetIqRef( long val )
{
	return MOTOR_OK;
}
...
RETURN:     MOTOR_OK on success, MOTOR_ERROR otherwise
----------------------------------------------------------------------*/
int BrushModule::SetIdRef( long val )
{
	return MOTOR_OK;
}
...
RETURN:     Encoder type
----------------------------------------------------------------------*/
int BrushModule::GetEncoderType()
{
	return MOTOR_OK;
}
...
RETURN:     MOTOR_OK on success, MOTOR_ERROR otherwise
----------------------------------------------------------------------*/
int BrushModule::SetEncoderType( int type )
{
	return MOTOR_OK;
}
...
RETURN:     MOTOR_OK on success, MOTOR_ERROR otherwise
----------------------------------------------------------------------*/
int BrushModule::ElecThetaGeneration( int mode )
{
	return MOTOR_OK;
}
...
RETURN:     MOTOR_OK on success, MOTOR_ERROR otherwise
----------------------------------------------------------------------*/
int BrushModule::SetMaxSpeed( int spd )
{
	return MOTOR_OK;
}
...
RETURN:     MOTOR_OK on success, MOTOR_ERROR otherwise
----------------------------------------------------------------------*/
int BrushModule::SetRamps( int mode )
{
	return MOTOR_OK;
}
...
----------------------------------------------------------------------*/
long BrushModule::ActualStartStopVelocity()
{
	return MOTOR_OK;
}
...
----------------------------------------------------------------------*/
long BrushModule::ActualAceleration()
{
	return MOTOR_OK;
}
...
----------------------------------------------------------------------*/
long BrushModule::ActualDeceleration()
{
	return MOTOR_OK;
}
...
RETURN:     MOTOR_OK on success, MOTOR_ERROR otherwise
----------------------------------------------------------------------*/
int BrushModule::SetActualPIDSpd( unsigned short set )
{
	return MOTOR_OK;
}
...
RETURN:     MOTOR_OK on success, MOTOR_ERROR otherwise
----------------------------------------------------------------------*/
int BrushModule::SetActualPIDPos( unsigned short set )
{
	return MOTOR_OK;
}
...
RETURN:     MOTOR_OK on success, MOTOR_ERROR otherwise
----------------------------------------------------------------------*/
int BrushModule::LoggerTriggerMode( int mode )
{
	return MOTOR_OK;
}
...
----------------------------------------------------------------------*/
long BrushModule::GetEncoderActualPulses()
{
	return MOTOR_OK;
}
...
RETURN:     MOTOR_OK on success, MOTOR_ERROR otherwise
----------------------------------------------------------------------*/
int BrushModule::SetPhaseCurrent( long val )
{
	return MOTOR_OK;
}
...
----------------------------------------------------------------------*/
long BrushModule::GetPhaseCurrent()
{
	return MOTOR_OK;
}
...
----------------------------------------------------------------------*/
int BrushModule::GetDecelerationAdvance()
{
	return MOTOR_OK;
}
...
RETURN:     MOTOR_OK on success, MOTOR_ERROR otherwise
----------------------------------------------------------------------*/
int BrushModule::SetDecelerationAdvance( int val )
{
	return MOTOR_OK;
}
...
RETURN:     MOTOR_OK on success, MOTOR_ERROR otherwise
----------------------------------------------------------------------*/
int BrushModule::SetPulsesToMm( int ptm )
{
	return MOTOR_OK;
}
...
RETURN:     MOTOR_OK on success, MOTOR_ERROR otherwise
----------------------------------------------------------------------*/
int BrushModule::DecCompensationMode( int mode )
{
	return MOTOR_OK;
}
...
RETURN:     MOTOR_OK on success, MOTOR_ERROR otherwise
----------------------------------------------------------------------*/
int BrushModule::SetProximityGap( long val )
{
	return MOTOR_OK;
}
...
----------------------------------------------------------------------*/
long BrushModule::GetProximityGap()
{
	return MOTOR_OK;
}
...
RETURN:     MOTOR_OK on success, MOTOR_ERROR otherwise
----------------------------------------------------------------------*/
int BrushModule::SetPIDPosActivationGap( long val )
{
	return MOTOR_OK;
}
...
----------------------------------------------------------------------*/
long BrushModule::GetPIDPosActivationGap()
{
	return MOTOR_OK;
}
...
RETURN:     MOTOR_OK on success, MOTOR_ERROR otherwise
----------------------------------------------------------------------*/
int BrushModule::SetIParkAngle( long val )
{
	return MOTOR_OK;
}
...
----------------------------------------------------------------------*/
long BrushModule::GetIParkAngle()
{
	return MOTOR_OK;
}
...
----------------------------------------------------------------------*/
long BrushModule::GetDangerLimit( int limit )
{
	return MOTOR_OK;
}
...
RETURN:     MOTOR_OK on success, MOTOR_ERROR otherwise
----------------------------------------------------------------------*/
int BrushModule::SetDangerLimit( int limit, long val )
{
	return MOTOR_OK;
}
...
RETURN:     MOTOR_OK on success, MOTOR_ERROR otherwise
----------------------------------------------------------------------*/
int BrushModule::DangerLimitMode( int mode )
{
	return MOTOR_OK;
}
...
RETURN:     MOTOR_OK on success, MOTOR_ERROR otherwise
----------------------------------------------------------------------*/
int BrushModule::HomeSensorInput( int val )
{
	return MOTOR_OK;
}
...
----------------------------------------------------------------------*/
long BrushModule::GetHomingSpeed( int speed )
{
	return MOTOR_OK;
}
...
RETURN:     MOTOR_OK on success, MOTOR_ERROR otherwise
----------------------------------------------------------------------*/
int BrushModule::SetHomingSpeed( int speed, long val )
{
	return MOTOR_OK;
}
...
RETURN:     MOTOR_OK on success, MOTOR_ERROR otherwise
----------------------------------------------------------------------*/
int BrushModule::SetOverSpeed( int val )
{
	return MOTOR_OK;
}
...
RETURN:     MOTOR_OK on success, MOTOR_ERROR otherwise
----------------------------------------------------------------------*/
int BrushModule::SetReferenceActualPos()
{
	return MOTOR_OK;
}
...
----------------------------------------------------------------------*/
int BrushModule::GetMaxReadCurrent()
{
	return MOTOR_OK;
}
...
----------------------------------------------------------------------*/
int BrushModule::SetMaxReadCurrent( int val )
{
	return MOTOR_OK;
}
...
----------------------------------------------------------------------*/
long BrushModule::GetEncoder360ActualPosition()
{
	return MOTOR_OK;
}
...
//----------------------------------------------------------------------
int BrushModule::SetAccFFWD( long val )
{
	return MOTOR_OK;
}
...
// RETURN:     MOTOR_OK if OK, MOTOR_ERROR otherwise
//----------------------------------------------------------------------
int BrushModule::SetSpdFFWD( long val )
{
	return MOTOR_OK;
}
...
// RETURN:     MOTOR_OK if OK, MOTOR_ERROR otherwise
//----------------------------------------------------------------------
int BrushModule::SetMaxJerk( int val )
{
	return MOTOR_OK;
}
...
// RETURN:     MOTOR_OK if OK, MOTOR_ERROR otherwise
//----------------------------------------------------------------------
int BrushModule::SetCFriction( long val )
{
	return MOTOR_OK;
}
...
----------------------------------------------------------------------*/
long BrushModule::GetEndMovementSpeed()
{
	return MOTOR_OK;
}
...
RETURN:     MOTOR_OK if OK, MOTOR_ERROR if errors
----------------------------------------------------------------------*/
int BrushModule::SetEndMovementSpeed( long val )
{
	return MOTOR_OK;
}
...
----------------------------------------------------------------------*/
long BrushModule::GetEndMovementDelta()
{
	return MOTOR_OK;
}
...
RETURN:     MOTOR_OK if OK, MOTOR_ERROR if errors
----------------------------------------------------------------------*/
int BrushModule::SetEndMovementDelta( long val )
{
	return MOTOR_OK;
}
...
// RETURN:     MOTOR_OK if OK, MOTOR_ERROR otherwise
//----------------------------------------------------------------------
int BrushModule::GotoPos0_Multi( unsigned char addX, long posX, unsigned char addY, long posY, long maxFreq, long acc, long proximityDeltaX, long proximityDeltaY )
{
	return MOTOR_OK;
}
...
RETURN:     MOTOR_OK if OK, MOTOR_ERROR if errors
----------------------------------------------------------------------*/
int BrushModule::ResetFlag_Multi()
{
	return MOTOR_OK;
}
...
----------------------------------------------------------------------*/
long BrushModule::GetEncoder2ActualPosition()
{
	return MOTOR_OK;
}
...
RETURN:     Encoder actual counter register
----------------------------------------------------------------------*/
long BrushModule::GetEncoder2ActualPulses()
{
	return MOTOR_OK;
}
...
RETURN:     Motor line encoder
----------------------------------------------------------------------*/
long BrushModule::GetLineEncoder2()
{
	return MOTOR_OK;
}
...
RETURN:     MOTOR_OK on success, MOTOR_ERROR otherwise
----------------------------------------------------------------------*/
int BrushModule::SetLineEncoder2( long lines )
{
	return MOTOR_OK;
}
...
RETURN:     Encoder actual position in IQ24
----------------------------------------------------------------------*/
long BrushModule::GetEncoderInterpActualPosition()
{
	return MOTOR_OK;
}
...
----------------------------------------------------------------------*/
int BrushModule::GetStatus_ResetFlagMulti()
{
	return MOTOR_OK;
}
...
RETURN:     MOTOR_OK on success, MOTOR_ERROR otherwise
----------------------------------------------------------------------*/
int BrushModule::SetFollowingError( long val )
{
	return MOTOR_OK;
}
...
----------------------------------------------------------------------*/
long BrushModule::GetFollowingError()
{
	return MOTOR_OK;
}
...
RETURN:     MOTOR_OK on success, MOTOR_ERROR otherwise
----------------------------------------------------------------------*/
int BrushModule::SetStartTicks( int ticks )
{
	return MOTOR_OK;
}
...
RETURN:     MOTOR_OK on success, MOTOR_ERROR otherwise
----------------------------------------------------------------------*/
int BrushModule::SetPhaseRotation( int value )
{
	return MOTOR_OK;
}
...
RETURN:     MOTOR_OK on success, MOTOR_ERROR otherwise
----------------------------------------------------------------------*/
int BrushModule::SetPhaseRotationNumber( int value )
{
	return MOTOR_OK;
}
...
RETURN:     MOTOR_OK on success, MOTOR_ERROR otherwise
----------------------------------------------------------------------*/
int BrushModule::SetSpeedFilter( unsigned short window )
{
	return MOTOR_OK;
}
...
RETURN:     MOTOR_OK on success, MOTOR_ERROR otherwise
----------------------------------------------------------------------*/
int BrushModule::SetSecurityCheck( int limit, int limitLevel )
{
	return MOTOR_OK;
}
...
RETURN:     MOTOR_OK on success, MOTOR_ERROR otherwise
----------------------------------------------------------------------*/
int BrushModule::SetSecurityInput( int val )
{
	return MOTOR_OK;
}
...
RETURN:     MOTOR_OK on success, MOTOR_ERROR otherwise
----------------------------------------------------------------------*/
int BrushModule::SetSteadyPosFollowError( long val )
{
	return MOTOR_OK;
}
...
----------------------------------------------------------------------*/
long BrushModule::GetSteadyPosFollowError()
{
	return MOTOR_OK;
}
...
RETURN:     MOTOR_OK on success, MOTOR_ERROR otherwise
----------------------------------------------------------------------*/
int BrushModule::SetEncoderSpykeDelta( int delta )
{
	return MOTOR_OK;
}
...
----------------------------------------------------------------------*/
int BrushModule::GetEncoderSpykeDelta()
{
	return MOTOR_OK;
}
...
RETURN:     MOTOR_OK on success, MOTOR_ERROR otherwise
----------------------------------------------------------------------*/
int BrushModule::SetSpeedProfile( int mode )
{
	return MOTOR_OK;
}
...
RETURN:     Temperature
----------------------------------------------------------------------*/
int BrushModule::GetTemperature()
{
	return MOTOR_OK;
}
...
RETURN:     MOTOR_OK on success, MOTOR_ERROR otherwise
----------------------------------------------------------------------*/
int BrushModule::UpdateOverSpeed()
{
	return MOTOR_OK;
}
...
RETURN:     MOTOR_OK on success, MOTOR_ERROR otherwise
----------------------------------------------------------------------*/
int BrushModule::OverSpeedCheck( int enable )
{
	return MOTOR_OK;
}
...
RETURN:     MOTOR_OK on success, MOTOR_ERROR otherwise
----------------------------------------------------------------------*/
int BrushModule::SetHomeSensorLevel( int level )
{
	return MOTOR_OK;
}
...
RETURN:     MOTOR_OK on success, MOTOR_ERROR otherwise
----------------------------------------------------------------------*/
int BrushModule::SetOutputDivider( int outId, int divider )
{
	return MOTOR_OK;
}
...
----------------------------------------------------------------------*/
int BrushModule::GetOutputDivider( int outId )
{
	return MOTOR_OK;
}
...
RETURN:     MOTOR_OK on success, MOTOR_ERROR otherwise
----------------------------------------------------------------------*/
int BrushModule::SetOutputReductionTime( int outId, int time )
{
	return MOTOR_OK;
}
...
----------------------------------------------------------------------*/
int BrushModule::GetOutputReductionTime( int outId )
{
	return MOTOR_OK;
}
...
RETURN:
----------------------------------------------------------------------*/
int BrushModule::SetHomeMove( long val )
{
	return MOTOR_OK;
}
...
----------------------------------------------------------------------*/
int BrushModule::MultiMotorMode(int mode)
{
	return MOTOR_OK;
}
...
RETURN:
----------------------------------------------------------------------*/
int BrushModule::SetHomeTimeout( long val )
{
	return MOTOR_OK;
}
...
RETURN:     0 OK, 1 if errors
----------------------------------------------------------------------*/
int BrushModule::StartRotation( int msec )
{
	if( isDisabled )
		return MOTOR_OK;

	if( SetDuration(msec) == MOTOR_ERROR )
	{
		//return MOTOR_ERROR;
		return MOTOR_OK;
	}
	if( errorCode = TWSBus1_Send_Command(m_comInt, this->m_Address, STARTROT_CMD, m_Data, serialComStatus) )
	{
		//return MOTOR_ERROR;
		return MOTOR_OK;
	}
...
RETURN:     0 OK, 1 if errors
----------------------------------------------------------------------*/
int BrushModule::SetDuration( int msec )
{
	if( isDisabled )
		return MOTOR_OK;

	if( Write_Reg_Micro(4, msec) )
	{
		return MOTOR_ERROR;
	}
...
OUTPUT:     -
GLOBAL:     -
RETURN:     Duration in msec if OK, 1 if errors
----------------------------------------------------------------------*/
int BrushModule::GetDuration()
{
	if( isDisabled )
		return MOTOR_OK;
...
RETURN:     0 OK, 1 if errors
----------------------------------------------------------------------*/
int BrushModule::SetDirection( int dir )
{
	if( isDisabled )
		return MOTOR_OK;

	if( Write_Reg_Micro(3, dir) )
	{
		return MOTOR_ERROR;
	}
...
OUTPUT:     -
GLOBAL:     -
RETURN:     Direction if OK, 1 if errors
----------------------------------------------------------------------*/
int BrushModule::GetDirection()
{
	if( isDisabled )
		return MOTOR_OK;
...
RETURN:     0 OK, 1 if errors
----------------------------------------------------------------------*/
int  BrushModule::SetOutputPulseMode(int outId, int mode){
	return MOTOR_OK;
}
...
RETURN:     0 OK, 1 if errors
----------------------------------------------------------------------*/
int  BrushModule::SetOutputPulseTime(int outId, int msec){
		return MOTOR_OK;
}
